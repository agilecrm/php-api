...
# Enter your sub domain name , agile email and agile api key

define("AGILE_DOMAIN", "jasonwoodlif");  # Example : define("domain","jim");
define("AGILE_USER_EMAIL", "narayanrupraut@agilecrm.com"); 
...
$new_contact_json1 = array(
  "id"=>"5706163895140352", 	// This contact id is related to unique@gmail.com. And it is mandatory. Example contact id :http://snag.gy/M6S3A.jpg
...
/*============================================================ create deal================================================*/
 ...
 $opportunity_json = array(
  ...
  "expected_value"=>1000,
  "milestone"=>"New",
  "custom_data"=>array(       //This is custom field which you should first define in custom field region.Example :http://snag.gy/OOuj8.jpg
    array(
      "name"=>"dataone",
      "value"=>"xyz"
    ),
